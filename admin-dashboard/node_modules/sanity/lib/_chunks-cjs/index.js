...
function UserComponentPane(props) {
  ...
  let t3;
  $[17] !== child || $[18] !== component || $[19] !== paneKey || $[20] !== restPane || $[21] !== restProps ? (t3 = reactIs.isValidElementType(component) && React.createElement(component, {
    ...restProps,
    ...restPane,
    ref: setRef,
    child,
  ...
  let t4;
  $[23] !== component ? (t4 = React.isValidElement(component) && component, $[23] = component, $[24] = t4) : t4 = $[24];
  let t5;
