...
function getDocumentHtml(studioRootPath, props, importMap) {
  ...
  return debug$2("Rendering document component using React"), `<!DOCTYPE html>${addTimestampedImportMapScriptToHtml(server.renderToStaticMarkup(React.createElement(Document, {
    ...defaultProps,
    ...props,
    css
  })), importMap)}`;
...
async function getViteConfig(options) {
  ...
  const customFaviconsPath = path__default.default.join(cwd, "static"), defaultFaviconsPath = path__default.default.join(path__default.default.dirname(sanityPkgPath), "static", "favicons"), staticPath = `${basePath}static`, viteConfig = {
    ...
    configFile: !1,
    mode,
    plugins: [viteReact__default.default(reactCompiler ? {
      babel: {
