...
function PaneContextMenuItem(props) {
  ...
  const t3 = node.iconRight || node.selected && icons.CheckmarkIcon;
  let t4;
  $[4] !== node.icon || $[5] !== node.onAction || $[6] !== node.selected || $[7] !== node.tone || $[8] !== t1 || $[9] !== t2 || $[10] !== t3 || $[11] !== title ? (t4 = /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.MenuItem, { disabled: t1, hotkeys: t2, icon: node.icon, iconRight: t3, onClick: node.onAction, pressed: node.selected, text: title, tone: node.tone }), $[4] = node.icon, $[5] = node.onAction, $[6] = node.selected, $[7] = node.tone, $[8] = t1, $[9] = t2, $[10] = t3, $[11] = title, $[12] = t4) : t4 = $[12];
  let t5;
  return $[13] !== t4 || $[14] !== tooltipContent ? (t5 = /* @__PURE__ */ jsxRuntime.jsx(sanity.TooltipOfDisabled, { content: tooltipContent, placement: "left", children: t4 }), $[13] = t4, $[14] = tooltipContent, $[15] = t5) : t5 = $[15], t5;
}
...
function PaneLayout(props) {
  ...
  const controller = t0, [rootElement, setRootElement] = React.useState(null), width = ui.useElementRect(rootElement)?.width || 0, collapsed = width === void 0 || !minWidth ? void 0 : width < minWidth;
  let t2;
  ...
  let t16;
  $[26] !== children || $[27] !== restProps || $[28] !== t13 || $[29] !== t14 || $[30] !== t15 ? (t16 = /* @__PURE__ */ jsxRuntime.jsx(Root$5, { "data-ui": "PaneLayout", ...restProps, "data-collapsed": t13, "data-resizing": t14, "data-mounted": t15, ref: setRootElement, children }), $[26] = children, $[27] = restProps, $[28] = t13, $[29] = t14, $[30] = t15, $[31] = t16) : t16 = $[31];
  let t17;
...
const preventDefault = (ev) => ev.preventDefault(), FormView = React.forwardRef(function(props, ref) {
  const {
    ...
    title
  } = useDocumentTitle(), patchChannel = React.useMemo(() => sanity.createPatchChannel(), []), isLocked = editState?.transactionSyncLock?.enabled, {
    t
...
const DocumentBox = styledComponents.styled(ui.Box)({
  ...
  const {
    ...
    schemaType
  }), [activeView, displayed, documentId, editState?.draft, editState?.published, schemaType, value]), lastNonDeletedRevId = sanity.useTimelineSelector(timelineStore, (state2) => state2.lastNonDeletedRevId), isLiveEdit = isLiveEditEnabled(schemaType);
  React.useEffect(() => {
...
function DocumentStatusBar(props) {
  const $ = reactCompilerRuntime.c(21), {
    ...
    title
  } = useDocumentTitle(), CreateLinkedActions = sanity.useSanityCreateConfig().components?.documentLinkedActions, showingRevision = sanity.useTimelineSelector(timelineStore, _temp$7), [collapsed, setCollapsed] = React.useState(null), [rootElement, setRootElement] = React.useState(null);
  let t0;
...
function DocumentLayout() {
  ...
  return schemaType ? /* @__PURE__ */ jsxRuntime.jsxs(sanity.GetFormValueProvider, { value, children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx(sanity.FieldActionsProvider, { actions: rootFieldActionNodes, path: EMPTY_ARRAY, children: /* @__PURE__ */ jsxRuntime.jsxs(DocumentActionShortcuts, { actionsBoxElement, as: Pane, currentMinWidth, "data-testid": "document-pane", flex: 2.5, id: paneKey, minWidth, onKeyUp: handleKeyUp, rootRef: setRootElement, children: [
      ...
      }, children: /* @__PURE__ */ jsxRuntime.jsx(ui.DialogProvider, { position: DIALOG_PROVIDER_POSITION, zOffset: zOffsets.portal, children: /* @__PURE__ */ jsxRuntime.jsx(PaneFooter, { ref: setFooterElement, children: /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.TooltipDelayGroupProvider, { children: /* @__PURE__ */ jsxRuntime.jsx(DocumentStatusBar, { actionsBoxRef: setActionsBoxElement, createLinkMetadata }) }) }) }) }),
...
const DocumentPaneProvider = React.memo((props) => {
  const {
    ...
    templateName,
    templateParams
  }), initialValue = sanity.useUnique(initialValueRaw), {
    patch
