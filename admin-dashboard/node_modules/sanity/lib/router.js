...
function RouteScope(props) {
  ...
  }, [scope, __unsafe_disableScopedSearchParams]), resolvePathFromState = React.useCallback((nextState_0) => parent_resolvePathFromState(resolveNextParentState(nextState_0)), [parent_resolvePathFromState, resolveNextParentState]), navigate = React.useCallback((nextState_1, options) => parent_navigate(resolveNextParentState(nextState_1), options), [parent_navigate, resolveNextParentState]), childRouter = React.useMemo(() => {
