...
const SharedStateProvider = function(props) {
  ...
  $[4] !== comlink2 ? (t3 = (key, value) => {
    sharedState.current[key] = value, comlink2?.post({
...
`, IFrame = react.forwardRef(function(props, ref) {
  ...
  let t0;
  $[0] !== animate || $[1] !== initial || $[2] !== onLoad || $[3] !== ref || $[4] !== src || $[5] !== variants ? (t0 = /* @__PURE__ */ jsxRuntime.jsx(IFrameElement, { animate, initial, onLoad, ref, src, variants }), $[0] = animate, $[1] = initial, $[2] = onLoad, $[3] = ref, $[4] = src, $[5] = variants, $[6] = t0) : t0 = $[6];
  let t1;
  $[7] !== preventClick ? (t1 = preventClick && /* @__PURE__ */ jsxRuntime.jsx(IFrameOverlay, {}), $[7] = preventClick, $[8] = t1) : t1 = $[8];
  let t2;
  return $[9] !== t0 || $[10] !== t1 ? (t2 = /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    t0,
    t1
  ] }), $[9] = t0, $[10] = t1, $[11] = t2) : t2 = $[11], t2;
});
...
const PERSPECTIVE_TITLE_KEY = {
  ...
  const $ = reactCompilerRuntime.c(6), renderDefault = _temp$2;
  let t0;
  ...
  let t3;
  return $[4] !== header ? (t3 = /* @__PURE__ */ jsxRuntime.jsx(ui.Card, { flex: "none", padding: 2, shadow: 1, style: t1, children: /* @__PURE__ */ jsxRuntime.jsx(ui.Flex, { align: "center", style: t2, children: header }) }), $[4] = header, $[5] = t3) : t3 = $[5], t3;
};
...
const MotionFlex = framerMotion.motion(ui.Flex), Preview = react.memo(react.forwardRef(function(props, forwardedRef) {
  const {
    dispatch,
    iframe,
    header,
  ...
  const preventIframeInteraction = react.useMemo(() => (loading || overlaysConnection === "connecting" && iframe.status !== "refreshing") && !continueAnyway, [continueAnyway, iframe.status, loading, overlaysConnection]), iframeAnimations = react.useMemo(() => [preventIframeInteraction ? "background" : "active", loading ? "reloading" : "idle", viewport, showOverlaysConnectionStatus && !continueAnyway ? "timedOut" : ""], [continueAnyway, loading, preventIframeInteraction, showOverlaysConnectionStatus, viewport]);
  return /* @__PURE__ */ jsxRuntime.jsx(framerMotion.MotionConfig, { transition: prefersReducedMotion ? {
    duration: 0
    ...
    /* @__PURE__ */ jsxRuntime.jsx(ui.Card, { flex: 1, tone: "transparent", children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { align: "center", height: "fill", justify: "center", padding: viewport === "desktop" ? 0 : 2, sizing: "border", style: {
      position: "relative",
      cursor: iframeIsBusy ? "wait" : void 0
    }, children: [
      /* @__PURE__ */ jsxRuntime.jsx(framerMotion.AnimatePresence, { children: !somethingIsWrong && !loading && !refreshing && showOverlaysConnectionStatus && !continueAnyway ? /* @__PURE__ */ jsxRuntime.jsx(MotionFlex, { initial: "initial", animate: "animate", exit: "exit", variants: spinnerVariants, justify: "center", align: "center", style: {
        inset: "0",
        position: "absolute",
      ...
      /* @__PURE__ */ jsxRuntime.jsx(IFrame, { animate: iframeAnimations, initial: ["background"], onLoad: onIFrameLoad, preventClick: preventIframeInteraction, ref, src: initialUrl.toString(), variants: iframeVariants })
    ] }) })
  ] }) });
}));
...
function useMainDocument(props) {
  const {
    ...
    apiVersion: index.API_VERSION
  }), [mainDocumentState, setMainDocumentState] = react.useState(void 0), mainDocumentIdRef = react.useRef(void 0), url = react.useMemo(() => {
  ...
  $[1] === Symbol.for("react.memo_cache_sentinel") ? (t2 = (event) => {
    setStatusMap((prev) => {
      ...
      if (event.status === "disconnected")
        ...
        const hasConnected_0 = next.get(event.channel)?.hasConnected || event.status === "connected";
        next.set(event.channel, {
          status: event.status,
...
function PresentationTool(props) {
  ...
  const toggleOverlay = react.useCallback(() => visualEditingComlink?.post({
    type: "presentation/toggle-overlay",
    data: void 0
  }), [visualEditingComlink]), [displayedDocument, setDisplayedDocument] = react.useState(null);
  react.useEffect(() => {
    const handleKeyUp = (e) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    ...
    controller && /* @__PURE__ */ jsxRuntime.jsx(react.Suspense, { children: /* @__PURE__ */ jsxRuntime.jsx(LoaderQueries, { controller, perspective, liveDocument: displayedDocument, onDocumentsOnPage: setDocumentsOnPage, onLoadersConnection: setLoadersConnection, documentsOnPage }) }),
    visualEditingComlink && params.id && params.type && /* @__PURE__ */ jsxRuntime.jsx(react.Suspense, { children: /* @__PURE__ */ jsxRuntime.jsx(PostMessageRefreshMutations, { comlink: visualEditingComlink, id: params.id, type: params.type, loadersConnection, previewKitConnection }) }),
    ...
    visualEditingComlink && documentsOnPage.length > 0 && /* @__PURE__ */ jsxRuntime.jsx(react.Suspense, { children: /* @__PURE__ */ jsxRuntime.jsx(PostMessagePreviewSnapshots, { comlink: visualEditingComlink, perspective, refs: documentsOnPage }) }),
