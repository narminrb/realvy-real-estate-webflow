...
import { useRef, useEffect, createContext, useContext, useLayoutEffect, useState, forwardRef, Suspense, memo, lazy, useMemo, useCallback, createElement, useImperativeHandle, startTransition, useReducer } from "react";
...
const SharedStateProvider = function(props) {
  ...
  $[4] !== comlink ? (t3 = (key, value) => {
    sharedState.current[key] = value, comlink?.post({
...
`, IFrame = forwardRef(function(props, ref) {
  ...
  let t0;
  $[0] !== animate || $[1] !== initial || $[2] !== onLoad || $[3] !== ref || $[4] !== src || $[5] !== variants ? (t0 = /* @__PURE__ */ jsx(IFrameElement, { animate, initial, onLoad, ref, src, variants }), $[0] = animate, $[1] = initial, $[2] = onLoad, $[3] = ref, $[4] = src, $[5] = variants, $[6] = t0) : t0 = $[6];
  let t1;
  $[7] !== preventClick ? (t1 = preventClick && /* @__PURE__ */ jsx(IFrameOverlay, {}), $[7] = preventClick, $[8] = t1) : t1 = $[8];
  let t2;
  return $[9] !== t0 || $[10] !== t1 ? (t2 = /* @__PURE__ */ jsxs(Fragment, { children: [
    t0,
    t1
...
const PERSPECTIVE_TITLE_KEY = {
  ...
  const $ = c(6), renderDefault = _temp$2;
  let t0;
  ...
  let t3;
  return $[4] !== header ? (t3 = /* @__PURE__ */ jsx(Card, { flex: "none", padding: 2, shadow: 1, style: t1, children: /* @__PURE__ */ jsx(Flex, { align: "center", style: t2, children: header }) }), $[4] = header, $[5] = t3) : t3 = $[5], t3;
};
...
const MotionFlex = motion(Flex), Preview = memo(forwardRef(function(props, forwardedRef) {
  const {
    dispatch,
    iframe,
    header,
  ...
  const preventIframeInteraction = useMemo(() => (loading || overlaysConnection === "connecting" && iframe.status !== "refreshing") && !continueAnyway, [continueAnyway, iframe.status, loading, overlaysConnection]), iframeAnimations = useMemo(() => [preventIframeInteraction ? "background" : "active", loading ? "reloading" : "idle", viewport, showOverlaysConnectionStatus && !continueAnyway ? "timedOut" : ""], [continueAnyway, loading, preventIframeInteraction, showOverlaysConnectionStatus, viewport]);
  return /* @__PURE__ */ jsx(MotionConfig, { transition: prefersReducedMotion ? {
    duration: 0
  } : void 0, children: /* @__PURE__ */ jsxs(TooltipDelayGroupProvider, { delay: 1e3, children: [
    /* @__PURE__ */ jsx(PreviewHeader2, {}),
    /* @__PURE__ */ jsx(Card, { flex: 1, tone: "transparent", children: /* @__PURE__ */ jsxs(Flex, { align: "center", height: "fill", justify: "center", padding: viewport === "desktop" ? 0 : 2, sizing: "border", style: {
      position: "relative",
      cursor: iframeIsBusy ? "wait" : void 0
    }, children: [
      /* @__PURE__ */ jsx(AnimatePresence, { children: !somethingIsWrong && !loading && !refreshing && showOverlaysConnectionStatus && !continueAnyway ? /* @__PURE__ */ jsx(MotionFlex, { initial: "initial", animate: "animate", exit: "exit", variants: spinnerVariants, justify: "center", align: "center", style: {
        inset: "0",
        position: "absolute",
      ...
      /* @__PURE__ */ jsx(IFrame, { animate: iframeAnimations, initial: ["background"], onLoad: onIFrameLoad, preventClick: preventIframeInteraction, ref, src: initialUrl.toString(), variants: iframeVariants })
    ] }) })
  ] }) });
}));
...
function useMainDocument(props) {
  const {
    ...
    apiVersion: API_VERSION
  }), [mainDocumentState, setMainDocumentState] = useState(void 0), mainDocumentIdRef = useRef(void 0), url = useMemo(() => {
...
function PresentationTool(props) {
  ...
  const toggleOverlay = useCallback(() => visualEditingComlink?.post({
    type: "presentation/toggle-overlay",
    data: void 0
  }), [visualEditingComlink]), [displayedDocument, setDisplayedDocument] = useState(null);
  useEffect(() => {
    const handleKeyUp = (e) => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    controller && /* @__PURE__ */ jsx(Suspense, { children: /* @__PURE__ */ jsx(LoaderQueries, { controller, perspective, liveDocument: displayedDocument, onDocumentsOnPage: setDocumentsOnPage, onLoadersConnection: setLoadersConnection, documentsOnPage }) }),
    visualEditingComlink && params.id && params.type && /* @__PURE__ */ jsx(Suspense, { children: /* @__PURE__ */ jsx(PostMessageRefreshMutations, { comlink: visualEditingComlink, id: params.id, type: params.type, loadersConnection, previewKitConnection }) }),
    ...
    visualEditingComlink && documentsOnPage.length > 0 && /* @__PURE__ */ jsx(Suspense, { children: /* @__PURE__ */ jsx(PostMessagePreviewSnapshots, { comlink: visualEditingComlink, perspective, refs: documentsOnPage }) }),
