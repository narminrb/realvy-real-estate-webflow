...
function ResultView(props) {
  ...
  if (isRecord(data) || Array.isArray(data)) {
    let t02;
    return $[0] !== data ? (t02 = /* @__PURE__ */ jsx(ResultViewWrapper, { children: /* @__PURE__ */ jsx(JSONInspector, { data, search: !1, isExpanded, onClick: toggleExpanded }) }), $[0] = data, $[1] = t02) : t02 = $[1], t02;
  }
  let t0;
  $[2] !== data ? (t0 = JSON.stringify(data), $[2] = data, $[3] = t0) : t0 = $[3];
  let t1;
  return $[4] !== t0 ? (t1 = /* @__PURE__ */ jsx(Code, { language: "json", children: t0 }), $[4] = t0, $[5] = t1) : t1 = $[5], t1;
}
